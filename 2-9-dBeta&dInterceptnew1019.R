...
load(paste0('200_sumlmHorizontal_Districts_cluster.Rdata'))
...
xall[xall$type == 'individual need',]$color = "grey52"
xall[xall$type == 'Area',]$color = "#619CFF"
...
# ####################
# yearrange = 1985:2017
# forclus = sumlmHorizontal[,c('yIndex','Beta','Intercept','year','type','clusMember')]
# forclus$year = forclus$year - 1
