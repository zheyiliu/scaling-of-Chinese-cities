...
tst = subset(POP, POP$city == '北京市')[,-1]

POP = IDDELF(POP)
POP = subset(POP, POP$value<3500)

POP1987 = subset(POP, POP$year==1987)
POP1986 = subset(POP, POP$year==1986)
POP1988 = subset(POP, POP$year==1988)
POP1987new = merge(POP1986, POP1988, by=c('city','index'))
POP1987new$value = (POP1987new$value.x + POP1987new$value.y)/2
POP1987new = POP1987new[,c('city','index','value')]
POP19871 = merge(POP1987, POP1987new, by=c('city','index'),all=T)
POP19871$value.x[which(is.na(POP19871$value.x))] = POP19871$value.y[which(is.na(POP19871$value.x))]
POP19871$id[which(is.na(POP19871$id))] = paste(POP19871$city[which(is.na(POP19871$id))], '1987', POP19871$index[which(is.na(POP19871$id))], 'lzy', sep='-')
POP19871$value = POP19871$value.x
POP19871$year = 1987
POP19871 = POP19871[,c('id','city','year','index','value')]
POP = subset(POP, POP$year!=1987)
POP = rbind(POP, POP19871)

POP1987 = subset(POP, POP$year==1998)
POP1986 = subset(POP, POP$year==1997)
POP1988 = subset(POP, POP$year==2000)
POP1987new = merge(POP1986, POP1988, by=c('city','index'))
POP1987new$value = (POP1987new$value.x + POP1987new$value.y)/2
POP1987new = POP1987new[,c('city','index','value')]
POP19871 = merge(POP1987, POP1987new, by=c('city','index'),all=T)
POP19871$value.x[which(is.na(POP19871$value.x))] = POP19871$value.y[which(is.na(POP19871$value.x))]
POP19871$id[which(is.na(POP19871$id))] = paste(POP19871$city[which(is.na(POP19871$id))], '1998', POP19871$index[which(is.na(POP19871$id))], 'lzy', sep='-')
POP19871$value = POP19871$value.x
POP19871$year = 1998
POP19871 = POP19871[,c('id','city','year','index','value')]
POP = subset(POP, POP$year!=1998)
POP = rbind(POP, POP19871)

POP1987 = subset(POP, POP$year==1999)
POP1986 = subset(POP, POP$year==1998)
POP1988 = subset(POP, POP$year==2000)
POP1987new = merge(POP1986, POP1988, by=c('city','index'))
POP1987new$value = (POP1987new$value.x + POP1987new$value.y)/2
POP1987new = POP1987new[,c('city','index','value')]
POP19871 = merge(POP1987, POP1987new, by=c('city','index'),all=T)
POP19871$value.x[which(is.na(POP19871$value.x))] = POP19871$value.y[which(is.na(POP19871$value.x))]
POP19871$id[which(is.na(POP19871$id))] = paste(POP19871$city[which(is.na(POP19871$id))], '1999', POP19871$index[which(is.na(POP19871$id))], 'lzy', sep='-')
POP19871$value = POP19871$value.x
POP19871$year = 1999
POP19871 = POP19871[,c('id','city','year','index','value')]
POP = subset(POP, POP$year!=1999)
POP = rbind(POP, POP19871)
...
Sewage.Length = IDDELF(Sewage.Length)
...
WaterSupply.Length = IDDELF(WaterSupply.Length)
...
### 去重
ElectricityResident = IDDELF(ElectricityResident)
...
### 去重
WaterResident = IDDELF(WaterResident)
